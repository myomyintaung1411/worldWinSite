      ...
      <div class="relative flex items-center justify-between">
        ...
        <div class="cursor-pointer text-center text-md text-gray-300 flex items-center space-x-2">
          ...
          <div @click="showMoney = !showMoney" class="cursor-pointer">
            <svg v-if="showMoney" class="h-6 w-6 text-primary" width="24" height="24" viewBox="0 0 24 24"
            ...
            <svg v-else class="h-6 w-6 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
