      ...
      <div class="w-full flex space-x-3">
        <div class="w-1/6 space-y-2">
          <div class="w-full flex flex-col space-y-2 items-center py-3 rounded-lg shadow-lg bg-slate-800 text-center">
            <div
              class="m-1 mr-2 w-16 h-16 relative flex justify-center items-center rounded-full bg-gray-500 text-xl text-white">
            ...
            <div v-for="(menu,index) in menuList" :key="index" @click="NavClick(menu,index)"
              ...
              <div class="flex  items-center justify-center ">
                <!-- <div>
                  ...
                  <DocumentTextIcon v-if="menu.path === '/transRecord'"
                    :class="activeRoute === menu.path? 'text-primary' : 'text-gray-400' "
                    class="h-7 w-7 hidden lg:block" />
                  <DocumentReportIcon v-if="menu.path === '/betRecord'" class="h-7 w-7 text-gray-400 hidden lg:block" />
                  <svg class="w-7 h-7" v-if="menu.path === '/myVip'" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                      d="M14 10l-2 1m0 0l-2-1m2 1v2.5M20 7l-2 1m2-1l-2-1m2 1v2.5M14 4l-2-1-2 1M4 7l2-1M4 7l2 1M4 7v2.5M12 21l-2-1m2 1l2-1m-2 1v-2.5M6 18l-2-1v-2.5M18 18l2-1v-2.5" />
                  </svg>
                  <svg class="w-7 h-7" fill="none" v-if="menu.path === '/mail'" stroke="currentColor"
                    viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                      d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
                  </svg>
                  <svg class="w-7 h-7" fill="none" v-if="menu.path === '/suggestion'" stroke="currentColor"
                    viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
  ...
  <div class="block md:hidden bg-slate-900 h-fit">
    <div class="w-full bg-gray-700 mx-auto">
      ...
      <div class="py-2">
        ...
        <div v-for="(menu,i) in m_menuList" :key="i" @click="m_NavClick(menu,i)"
          class="py-2 my-2 flex justify-between shadow-lg bg-slate-900 px-3 rounded text-center items-center">
          <div class="flex text-center items-center">
            <!-- <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 8l3 5m0 0l3-5m-3 5v4m-3-5h6m-6 3h6m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg> -->
